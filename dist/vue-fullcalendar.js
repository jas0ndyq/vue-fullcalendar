...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "E:\\jason\\proj\\vue-fullcalendar\\src\\fullCalendar.vue"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "E:\\jason\\proj\\vue-fullcalendar\\src\\components\\body.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    dayDbClick: function dayDbClick(day, ev) {
	      console.log('double click @', day);
	      this.$emit('dayDbClick', day, ev);
	    }
	  }
	}; //
	//
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "E:\\jason\\proj\\vue-fullcalendar\\src\\components\\header.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._v(_vm._s(_vm.rightArrow))]), _vm._v(" "), _c('span', {
	    on: {
	      "click": function($event) {
	        _vm.goDayInMonth()
	      }
